...
function propfirm_comparison_frontend_scripts() {
    ...
    wp_enqueue_script( 'propfirm-comparison-widget-bootstrap-script', true );
}
add_action( 'elementor/frontend/after_register_scripts', 'propfirm_comparison_frontend_scripts' );